...
To activate multiple SIM cards, please read this article on [bulk activation](activate-or-change-sim-status/how-to-activate-sim-cards-in-bulk.md).  
...
4 & 5. (Optional Steps) Add a [**reference**, **line & subscriber details**](how-to-group-tag-and-label-your-sims.md), and add the SIM to a **group**  
...
More information on number portability can be found on the [Mobile Number Portability](mobile-number-portability/README.md) page  
