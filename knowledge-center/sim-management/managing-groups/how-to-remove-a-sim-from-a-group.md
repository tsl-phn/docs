---
title: "Removing SIMs from a group"
---
...
## [Managing Groups](README.md)

- [Creating groups of SIMs](../creating-groups-of-sims.md)
- [Editing, managing or deleting SIM groups](how-to-edit-manage-or-delete-sim-groups.md)
- [Adding multiple SIMs to a group](../how-to-add-multiple-sims-to-a-group.md)
- [Removing SIMs from a group](how-to-remove-a-sim-from-a-group.md)
- [Adding a SIM to a group](how-to-add-a-sim-to-a-group.md)
...
– By transferring the SIM to another group (it will automatically be removed from the old one and added to the new one) – [This article will explain how to add the SIM to a group](how-to-add-a-sim-to-a-group.md)  
...
You can then select the SIMs using the [filters from the filter panel](https://docs.transatel.com/getting-started/groups-filters/how-to-use-the-filter-panel/) if needed.  
