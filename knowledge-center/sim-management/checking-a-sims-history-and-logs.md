---
title: "Checking a SIM\u2019s history and logs"
---

# Checking a SIM’s history and logs
...
In your SIM’s detailed page, go to the “Log” tab to display the history of all the changes made to the SIM since its activation.  
You will be able to track:  
– the timestamp of the start & end of the change  
– the status of the action (processed, failed, in progress)  
