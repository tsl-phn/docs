...
1/ Duplicating an existing user  
2/ Creating a new user from scratch  
  
We highly recommend to use the 1st solution, as there are a lot of user rights, and it is easier to remove/add some, than to select them all from a blank slate.  
...
1/ **How to duplicate a user account**  
