...
To be able to manage user accounts in the interface, your own user account must:  
– have the Admin scope  
– have the rights to read and manage users: “Any\_User\_Write” and “Any\_User\_read”  
...
– change the user account’s language  
– activate or deactivate the account ([click here for further details](https://docs.transatel.com/user-management/deactivating-or-deleting-user-accounts/))  
– add or remove rights & scopes to the user account  
  
**Adding or removing rights**   
