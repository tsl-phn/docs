...
This article is related to the new system. If your account’s users have not yet been migrated, please refer to the articles concerning the [old user management system](managing-editing-user-accounts.md)

In the ‘manage users’ menu, you can find all the users linked to your account(s)
...
You can use the search panel to search users by:
