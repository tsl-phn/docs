---
title: "Getting Started with Ubigi for Business"
---

# Getting Started with Ubigi for Business
...
This page contains a quick start guide with the minimum necessary steps to activate your first SIMs on the Ubigi for Business offer.  
We have a full User Guide for Ubigi for Business fleet administrators. If you have not receive it, please ask your account manager!  
  
In this Quick Start Guide you will learn:  
1) What are the SIM statuses and the SIM’s lifecycle  
2) What are Service Profiles  
3) How to create your first Service Profile  
4) How to activate your first SIMs, unitarily or in bulk  
5) How to add bundles on SIMs in the Ubigi bundle pricing model
...
– Allow or deny certain types of usages, select services…and in Ubigi for Business, this is where you will **select the Pricing Model for the SIM**  
– Set usage limits & decide what should happen if they’re reached  
  
**To activate a SIM card in the interface, you must select a Service Profile – but you can change the Profile during the SIM’s lifecycle.**  
...
**4) Activating your first SIM cards**
...
[About bundles with delayed activation](../../services/plans-bundles/bundles-with-delayed-activation.md)  
...
– [On the Ubigi website] how to install an eSIM on an [iPhone](https://cellulardata.ubigi.com/ios/iphone/activate-your-esim/) or [Android](https://cellulardata.ubigi.com/android/activate-your-esim/) device
