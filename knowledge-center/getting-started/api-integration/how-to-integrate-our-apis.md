---
title: "How to integrate our APIs?"
---
...
The **[Transatel Developer Portal](https://developers.transatel.com/)** is where you’ll find all API resources, including:  
– All you need to know on how to integrate our APIs,   
– The links to the API reference for each specific API   
...
**Note: API credentials are not the same as the user for the SIM Management Portal. You cannot use your interface user to use our APIs.**  
