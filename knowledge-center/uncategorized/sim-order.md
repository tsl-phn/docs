...
Once SIM ordering is enabled for your account, **your Account Manager will contact you** to share all details and next steps.

How does SIM order work?
...
## Creating a new SIM order

Each of these actions is related to a specific scope, so you can give the right accesses to people in your organization
...
An order can be validated:

- Immediately when it is placed, if the user has the right to validate orders
- Any time, by clicking on the “check” icon, and then confirming the order by clicking on “purchase”
...
The order is first created in the “Pending Validation” status.

Once the order has been validated:

- It will be attributed a CSO (Customer SIM Order) reference appear.

Please use this reference if you have any questions regarding an order.
...
You can search the SIM cards by order reference:
