...
For full details, see [Premium SMS – Knowledge Centre](premium-sms.md).
...
For full details, see [Shortcode Voice – Knowledge Centre](shortcode-voice.md).
...
For full details, see [NGCS Voice – Knowledge Centre](ngcs-voice-non-geographic-call-services.md).
...
All Premium Services are subject to [Payment Safeguarding (PSG)](../high-usage-and-subscriber-protection/payment-safeguarding-psg.md), which enforces regulatory spend limits and protects subscribers from excessive charges.
