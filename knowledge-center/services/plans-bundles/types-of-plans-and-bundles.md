---
title: "Pricing models of our IoT offers"
---
...
[Click here](https://docs.transatel.com/services-setup/plans-bundles/iot-understanding-pooled-bundles/) to learn more on pooled bundles, and [here](https://docs.transatel.com/services-setup/iot-adding-sim-cards-to-a-pooled-bundle/) to find out how to switch a SIM to a new rate plan.   
...
[Adding a capped bundle](https://docs.transatel.com/services-setup/iot-adding-a-capped-bundle-to-a-sim/) to a SIM is done in the SIM’s detailed page, in the “Plan and options” tab  
[Click here](https://docs.transatel.com/services-setup/iot-understanding-capped-bundles/) to learn more on the management of capped bundles in the interface  
