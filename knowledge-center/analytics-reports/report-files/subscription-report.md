...
**What is the subscription report?**

The report provides the service provider with a view of the fleet subscriptions’ status.

**Subscription report specifications**
